...
return [
    ...
    */
    'attributes' => [
        ...
        "tagsList" => "لیست برچسب ها",
        "clientId" => "شناسه مشتری",
        "galleries" => "لیست گالری",
        "summery" => "توضیح مختصر",
        "showInSlider" => "نمایش در اسلایدر",
        "finishedAt" => "تاریخ اتمام پروژه",
        "order" => "ترتیب نمایشی",
        "isActive" => "فعال است یا خیر",
        "projectId" => "شناسه پروژه",
        "lastJobTitle" => "آخرین عنوان شغلی",
        "organizationName" => "نام سازمان",
        "activityInOrganization" => "زمینه فعالیت سازمان",
        "startDate" => "تاریخ شروع",
        "finishDate" => "تاریخ پایان",
        "stillWork" => "هنوز مشغولم",
        "birthday" => "تاریخ تولد",
        "sex" => "جنسیت",
        ...
        "provinceId" => "استان",
        "cityId" => "شهر",
        "startedAt" => "تاریخ شروع پروژه",
        "isContractor" => "پیمانکار هستید",
        "contractorId" => "پیمانکار",
        "contractDuration" => "مدت زمان قرارداد",
        "mobileImage" => "عکس حالت موبایل",
        "mobileFile" => "فایل حالت موبایل",
